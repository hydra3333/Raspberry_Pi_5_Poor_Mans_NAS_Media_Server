...
set "Path_to_py_crosstab_filecount=!root!z_crosstab_filecount.py"
...
ECHO "!py_exe!" "!Path_to_py_crosstab_filecount!" >> "!vrdlog!" 2>&1
"!py_exe!" "!Path_to_py_crosstab_filecount!" >> "!vrdlog!" 2>&1
ECHO !DATE! !TIME! >> "!vrdlog!" 2>&1

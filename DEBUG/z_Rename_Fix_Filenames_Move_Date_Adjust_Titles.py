...
def change_filename_layout(new_basename):
    ...
    new_basename = case_insensitive_replace(new_basename, "-SBS_VICELAND", "")
    new_basename = case_insensitive_replace(new_basename, "_SBS_VICELAND", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-ABC2", "")
    new_basename = case_insensitive_replace(new_basename, "_ABC2", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-ABC_Entertains", "")
    new_basename = case_insensitive_replace(new_basename, "_ABC_Entertains", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-Channel_9", "")
    new_basename = case_insensitive_replace(new_basename, "_Channel_9", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-7_Digital", "")
    new_basename = case_insensitive_replace(new_basename, "_7_Digital", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-7mate", "")
    new_basename = case_insensitive_replace(new_basename, "_7mate", "")

...
set "T01=2015.11.29-Jess-21st-birthday-party"
set "T02=REM "BigIdeas"
set "T03=REM "CharlieWalsh"
set "T04=REM "ClassicDocumentaries"
set "T05=REM "ClassicMovies"
set "T05=Documentaries"
set "T06=Footy"
set "T07=HomePics"
set "T08=Movies"
set "T09=Movies_unsorted"
set "T10=Music"
set "T11=MusicVideos"
set "T12=OldMovies"
set "T13=SciFi"
...
set RoboSwitches=/IT /COPY:DAT /DCOPY:DAT /XJD /XJF /E /Z /J /TIMFIX /TS /R:10 /FP /XC /XO /XN /ETA /TEE 
REM note /XC /XO /XN to only copy files that do not exist

REM call :compare_folders "%D1%" "%D2%" "%T13%"

REM First round consolidates everything into D1 and partially into the rest as it goes along
call :copy_folders "%D1%" "%D2%" "%T13%"
call :copy_folders "%D1%" "%D3%" "%T13%"
call :copy_folders "%D1%" "%D4%" "%T13%"
call :copy_folders "%D1%" "%D5%" "%T13%"
REM Second round copies accumulated files in D1 into the rest
call :copy_folders "%D1%" "%D2%" "%T13%"
call :copy_folders "%D1%" "%D3%" "%T13%"
call :copy_folders "%D1%" "%D4%" "%T13%"
call :copy_folders "%D1%" "%D5%" "%T13%"
...
:compare_folders
REM to only compare:
robocopy "%~1\%~3" "%~2\%~3" /L /E /FP /NP
robocopy "%~2\%~3" "%~1\%~3" /L /E /FP /NP
goto :eof

:copy_folders
robocopy "%~1\%~3" "%~2\%~3" %RoboSwitches%
robocopy "%~2\%~3" "%~1\%~3" %RoboSwitches%
goto :eof

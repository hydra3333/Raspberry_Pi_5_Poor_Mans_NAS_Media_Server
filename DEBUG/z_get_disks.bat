...
REM ECHO !DATE! !TIME! DEL /F "!tempfile!" >> "!vrdlog!" 2>&1
REM DEL /F "!tempfile!" >> "!vrdlog!" 2>&1
...
REM ECHO !DATE! !TIME! DEL /F "!temp_cmd_file!" >> "!vrdlog!" 2>&1
REM DEL /F "!temp_cmd_file!" >> "!vrdlog!" 2>&1```
REM --------- setup LOG file and TEMP filenames ----------------------------


set "Path_to_py_z_get_disks=!root!z_get_disks.py"
...
REM ECHO "!py_exe!" "!Path_to_py_z_get_disks!" >> "!vrdlog!" 2>&1
"!py_exe!" "!Path_to_py_z_get_disks!"
REM ECHO !DATE! !TIME! >> "!vrdlog!" 2>&1
